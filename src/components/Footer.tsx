        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/" className="text-gray-300 hover:text-white transition-colors">EOR India</Link></li>
              <li><Link href="/contractor-management-india" className="text-gray-300 hover:text-white transition-colors">Contractor Management</Link></li>
